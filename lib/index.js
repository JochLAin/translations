...
exports.visitCatalog = exports.translate = exports.mergeCatalogs = exports.Translator = void 0;
...
Translator.visitCatalog = (catalog, key) => {
    const visit = (catalog, ...keys) => {
        if (!catalog)
            return key;
        ...
        while (keys.length) {
            ...
            if (value)
                return visit(catalog[currentKey], ...keys);
        }
        return '';
    };
...
exports.visitCatalog = Translator.visitCatalog;
