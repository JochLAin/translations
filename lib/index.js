...
exports.translate = exports.Translator = void 0;
...
class Translator {
    constructor(translations) {
        ...
        this.addCatalog = (messages, domain = contants_1.DEFAULT_DOMAIN, locale = this.fallbackLocale) => {
            ...
            this.translations.set(Translator.getKey(domain, locale), merge(this.getCatalog(domain, locale), messages));
            return this;
        };
