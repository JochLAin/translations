...
exports.visitCatalog = exports.merge = exports.create = exports.translate = exports.mergeCatalogs = exports.getCatalogValue = exports.formatMessage = exports.createTranslator = exports.Translator = exports.DEFAULT_LOCALE = exports.DEFAULT_DOMAIN = void 0;
const constants_1 = require("./constants");
Object.defineProperty(exports, "DEFAULT_DOMAIN", { enumerable: true, get: function () { return constants_1.DEFAULT_DOMAIN; } });
Object.defineProperty(exports, "DEFAULT_LOCALE", { enumerable: true, get: function () { return constants_1.DEFAULT_LOCALE; } });
const format_1 = __importDefault(require("./format"));
class Translator {
    constructor(translations) {
        this.fallbackDomain = constants_1.DEFAULT_DOMAIN;
        this.fallbackLocale = constants_1.DEFAULT_LOCALE;
        this.formatter = { format: format_1.default };
        this.addCatalog = (catalog = {}, domain = this.fallbackDomain, locale = this.fallbackLocale) => {
        ...
        this.getCatalog = (domain = this.fallbackDomain, locale = this.fallbackLocale) => {
        ...
        this.setFallbackDomain = (domain = constants_1.DEFAULT_DOMAIN) => {
            this.fallbackDomain = domain;
            return this;
        };
        this.setFallbackLocale = (locale = constants_1.DEFAULT_LOCALE) => {
    ...
    static create(translations = {}, options = {}) {
        const { domain = constants_1.DEFAULT_DOMAIN, locale = constants_1.DEFAULT_LOCALE, formatter } = options;
    ...
    ;
    static translate(catalog = {}, replacements = {}, locale = constants_1.DEFAULT_LOCALE, formatter = { format: format_1.default }) {
...
exports.formatMessage = format_1.default;
